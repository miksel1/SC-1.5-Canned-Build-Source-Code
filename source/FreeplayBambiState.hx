...
class FreeplayBambiState extends MusicBeatState
{
	var songs:Array<SongBambiMetadata> = [];
	...
	private var mainSongsState:Array<String> = ['Blocked', "Sweetcorn", 'Revise', 'Cob', 'Idiot', 'Apathetic', 'Harvest', 'Overthink', 'Nomophobia', 'Dismember', 'Kalampokiphobia', 'Reality-Breaking', 'Opposition', 'Cheating', 'Shit', 'Unfairness', 'Phonophobia'];
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String, color:Int)
	{
		if(mainSongsState.contains(songName))
			{
				songs.push(new SongBambiMetadata(songName, weekNum, songCharacter, color));
			}
	}
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			MusicBeatState.switchState(new FreeplaySectionsState());
		}
