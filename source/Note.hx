...
class Note extends FlxSprite
{
	...
	{
		charactersCustomizableNotes = CoolUtil.coolTextFile(Paths.txt('charactersCustomizableNotes'));
		super();
		...
		if (isSustainNote && prevNote != null)
		{
			...
			if (prevNote.isSustainNote)
			{
				...
				if(PlayState.SONG.song == 'Unfairness' || PlayState.SONG.song == 'unfairness')
				{
				prevNote.scale.y *= Conductor.stepCrochet / 100 * 1.05 * FlxG.random.float(0.1, 3);
				}
				else {
