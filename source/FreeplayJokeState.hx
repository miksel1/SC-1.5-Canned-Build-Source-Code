...
class FreeplayJokeState extends MusicBeatState
{
	var songs:Array<SongJokeMetadata> = [];
	...
	private var mainSongsState:Array<String> = ['Cheeting', "Vs-dave-halloween", 'hjoim', 'Spamophobia'];
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String, color:Int)
	{
		if(mainSongsState.contains(songName))
			{
				songs.push(new SongJokeMetadata(songName, weekNum, songCharacter, color));
			}
	}
