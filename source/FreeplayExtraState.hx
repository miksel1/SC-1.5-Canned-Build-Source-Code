...
class FreeplayExtraState extends MusicBeatState
{
	...
	private var mainSongsState:Array<String> = ['Automation','Ornery', "Golden", 'Potent', 'Obscure', 'Delirium'];
	...
	override function create()
	{
		...
		for (i in 0...songs.length)
		{
			...
			{
				if(songs[i].songName == 'Ornery' && !FlxG.save.data.orneryUnlocked1 && !FlxG.save.data.orneryUnlocked2) //old one was tutorialCompletePlaceholder2
					{
